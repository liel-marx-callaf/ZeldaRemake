...
namespace Helper
{
    ...
    public static class BoxCastDrawer
    {
        ...
        {
            Debug.DrawLine(firstBox[0], secondBox[0], color, 2f);
            Debug.DrawLine(firstBox[1], secondBox[1], color, 2f);
            Debug.DrawLine(firstBox[2], secondBox[2], color, 2f);
            Debug.DrawLine(firstBox[3], secondBox[3], color, 2f);
        }
