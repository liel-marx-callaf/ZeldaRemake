...
public class SideRoomPortal : MonoBehaviour
{
    ...
    [SerializeField] private string sideRoomSceneName = "StartingSideRoom";

    [Header("Fade and Animation")]
    [SerializeField] private Animator fadeAnimator;    // fade to black
    [SerializeField] private float fadeDuration = 1f;  // how long the fade is
    [SerializeField] private string enterAnimationTrigger = "RoomEnter"; 
