...
public class TektiteMovementOld : MonoBehaviour, IPoolable
{
    ...
    [SerializeField, Range(1f, 12f)] private float jumpRange = 3f;
    ...
    private void Jump()
    {
        ...
        Debug.Log("before clamp Jumping to: " + _xDestination + " " + _yDestination);
        _xDestination = Mathf.Clamp(_xDestination, _topLeftBorder.x - edgeBuffer, _bottomRightBorder.x + edgeBuffer);
        _yDestination = Mathf.Clamp(_yDestination, _bottomRightBorder.y - edgeBuffer, _topLeftBorder.y + edgeBuffer);
        Debug.Log("after clamp Jumping to: " + _xDestination + " " + _yDestination);
    ...
    private IEnumerator JumpCoroutine()
    {
        ...
        Vector2 jumpDirection = new Vector2(_xDestination - _currentPosition.x, _yDestination - _currentPosition.y)
            .normalized;
